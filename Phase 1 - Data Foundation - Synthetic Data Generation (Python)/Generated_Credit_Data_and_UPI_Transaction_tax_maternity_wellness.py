# =============================================================================
# FILE: data_generator.py (FINAL, COMPLETE VERSION)
# =============================================================================
import pandas as pd
import numpy as np
...
# Flag a subset of female users for menstrual leave patterns
is_female = df['gender'] == 'Female'
random_chance = np.random.rand(NUM_RECORDS)
df['takes_menstrual_leave'] = is_female & (random_chance < 0.1)
...
#women maternity age upper from 40 to 45
#women menstrual leave factor removed